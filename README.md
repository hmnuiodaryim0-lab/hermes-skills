...
| 技能 | 说明 |
|------|------|
| amap | 高德地图 Web Service API 工具集（地理编码/逆编码/天气/路径规划/POI搜索等），基于官方API实现 |
...
| platform-rules | 平台内容边界规则 —— 微信环境下限制提及特定平台/工具（禁止 Telegram/Discord/OpenAI/GitHub 等），其他平台无限制 |
...
# 只提交个性化技能
git add amap bazi-mingli cyber-cultivation platform-rules travel-research
git commit -m "update: ..."
...
```bash
hermes skills install hmnuiodaryim0-lab/hermes-skills amap
...
hermes skills install hmnuiodaryim0-lab/hermes-skills platform-rules
